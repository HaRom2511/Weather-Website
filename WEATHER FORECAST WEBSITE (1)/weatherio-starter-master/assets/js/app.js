            ...
            fetchData(url.geo(searchField.value), function(locations){
                    ...
                    <ul class ='view-list' data-search-list>
                        ...
                        <li class ='view-item'>
                            ...
                            <div>
                                ...
                                <p class="label-2 item-subtitle">State</p>
                            </div>
                ...
                for(const {name, lat, lon, country, state} of locations){
                    ...
                    searchItem.innerHTML = `
                        ...
                        class="item-link has-state" aria-label="${name} weather" data-search-toggler></a>
...
const current = document.querySelector("[data-current-location-btn]");
            ...
            <div class="highlight-list">
                ...
                <div class="card card-sm highlight-card">
                    ...
                    <div class="wrapper">
                        ...
                        <p class="title-1">${humidity}<sub>%</sup></p>
                    </div>
                </div>
                ...
                <div class="card card-sm highlight-card">
                    ...
                    <div class="wrapper">
                        ...
                        <p class="title-1">${visibility / 1000}<sub>km</sup></p>
                    </div>
            ...
            for (const [index, data] of forecastList.entries()){
                ...
                windLi.innerHTML =`
                    <div class="card card-sm slider-card">
                        ...
                        height="48" loading="lazy" alt="direction" class="weather-icon" 
